...
// Generated
#include "AscMapKitEnvironmentAreaPropertiesDamagePlayersStruct.generated.h"

USTRUCT(Blueprintable, BlueprintType)
struct ASCMAPKIT_API FAscMapKitEnvironmentAreaPropertiesDamagePlayersStruct
{
	GENERATED_BODY()

	// Check to enable damage against players.
