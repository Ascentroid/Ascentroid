...
// Generated
#include "AscMapKitTriggerPropertiesOnHideActorsStruct.generated.h"

USTRUCT(Blueprintable, BlueprintType)
struct ASCMAPKIT_API FAscMapKitTriggerPropertiesOnHideActorsStruct
{
    GENERATED_BODY()
    ...
    // A list of actor tags that will find the actor(s) and hide them when this operation executes.
    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame)
    TArray<FString> ActorTagsToHide;

    // Check this if you want to hide a HUD message when the actor(s) are hidden.
    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame)
    bool ShowHudMessage;
