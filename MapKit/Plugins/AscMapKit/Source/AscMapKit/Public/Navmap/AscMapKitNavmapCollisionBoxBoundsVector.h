...
// Generated
#include "AscMapKitNavmapCollisionBoxBoundsVector.generated.h"

USTRUCT(BlueprintType)
struct FAscMapKitNavmapCollisionBoxBoundsVector
{
	GENERATED_BODY()

	FAscMapKitNavmapCollisionBoxBoundsVector() : X(0.f), Y(0.f), Z(0.f) {}
